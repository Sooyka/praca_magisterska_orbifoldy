...
As an appendix, there is a sample implementation of this algorithm with full described 
enhancments, written in Rust. It is in the separate file, as it would take too much space in this 
