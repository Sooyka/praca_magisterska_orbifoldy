...
Analogously to \ref{algorithm reduction to D2}, we will wlog answear the question fr $ M = D^2$. 
...
we know, that $\frac{p}{q}$ is an ccumulation point of order $n_0$ in $\speD$. 
