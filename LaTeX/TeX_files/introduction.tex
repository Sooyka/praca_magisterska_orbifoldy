...
from geometry, to number theory -- e.g. as spaces correlated with modular forms \cite{Hain2014}, 
...
infinite dihedral group and an orbifold corresponding to symmetry about a folding frequency
 (\href{https://en.wikipedia.org/wiki/Infinite_dihedral_group}{link}), music theory -- e.g. 
in modeling musical tones \cite{Mazzola2002}, \cite{Tymoczko2006}, and art -- they are visible e.g. 
