...
In dimension two, only possible groups acting on the map sets are (\cite{Thurston1979} 
Proposition 13.3.1):
\begin{itemize}
...
\begin{equation}\label{area curvature integral}
...
\begin{equation}\label{curvature integral \Eoc}
...
The proof from \cite{Thurston1979} (theorem 13.3.6.) can be also adapted to the case 
of orbifolds in a sense of definition extended by subsection \ref{compactness}, to show that 
they also admit metric structure with finite area and that equations 
\ref{area curvature integral}, \ref{curvature integral \Eoc} and \ref{area to chi} 
also holds in elliptic and hyperbolic cases. 
In this case however, the metric won't be defined on the cusp points themselves 
(which lie in the compactification).  
...
As stated in section \ref{therminology and notation} we will often see two dimensional orbifold 
...
that do not change \Eoc, which will be used in section \ref{sufficiency of D2 and S2}.
