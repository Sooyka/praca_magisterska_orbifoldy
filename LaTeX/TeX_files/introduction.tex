...
What is interesting, although techniques used to obtain them are completly different, 
...
Orbifold
\end{definition}
It will have sligth slight modification described in \ref{compactness}. 
...
\subsection{Addition of sets of numbers}
For $A, B \subseteq \mathbb{R}$, we define 
\begin{equation}
A+B \coloneq \{a+b\ |\ a \in A, b\in B\}.
\end{equation}
...
\end{equation}
where sum is taken other all compact manifolds possibly with boundary.
