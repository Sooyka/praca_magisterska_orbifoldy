...
\chi(M) - n + \sum_{i=1}^n \frac{1}{r_i}
\end{equation}
and
\begin{equation}\label{Egyptian D2 sum}
\chi(M) - \frac{m}{2} + \frac{1}{2}\sum_{j=1}^m \frac{1}{d_j}.
\end{equation}
...
\begin{theorem}\label{from Egyptian fractions M}
...
\begin{equation}
\chi(M) - \frac{n}{2} + \frac{x}{2} \in \spebr{M}.
\end{equation}
\end{theorem}
\begin{theorem}\label{to egyptian fractions M}
...
we have that $y \in \spebr{M}$ as an \Eoc of an orbifold which all orbipoints 
are $m$ rotational orbipoints, 
then \begin{equation}
2y + \frac{m}{2} - \chi(M)
\end{equation}
can be expressed as an egyptian fraction with $m$ 
