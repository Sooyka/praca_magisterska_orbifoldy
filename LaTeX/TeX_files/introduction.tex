...
Let $n_1'$ be the smallest value $n_1$ can take, such that $\frac{1}{n_1'} < \frac{1}{q}$. 
...
smallest values for $n_1, n_2, \cdots, n_{i-1}$, then we have, that 
$\frac{1}{n_i} \geq \cdots \geq \frac{1}{n_k} \geq q - \frac{1}{n_1'} - \frac{1}{n_2'} - 
\cdots -\frac{1}{n_{i-1}}$. 
