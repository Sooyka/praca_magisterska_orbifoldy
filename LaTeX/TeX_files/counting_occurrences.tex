...
decreases an \Eoc\ . \\
It remains to proove then, that for any base manifold $M$, there are only finetly many orbifolds, 
with: \\
-an \Eoc\ $y \geq x$, \\
-all orbipoints of order at most $n$ and\\  
-with $M$ as a base manifold. \\
