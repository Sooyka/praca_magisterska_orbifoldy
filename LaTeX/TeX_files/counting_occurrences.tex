...
But $\{y_n\} \subseteq \speM{M} - \chi(M)$. 
From \ref{well_order} and \ref{times_two_fact} we know that $\speM{M}$ has no infinite 
strongly increasing sequences, so 
$\speM{M} - \chi(M)$ has no infinite strongly increasing sequences. That gives us a 
contradiction.
%*. 
%\Lightning 
$_\square$ 
