...
\end{equation}
%\begin{observation}
%If two-dimentional manifold  $M$ has no boundry, then $\sigma(M) \subseteq \speS$. 
%If, in addition, $M \neq S^2$, then 
%$\sigma(M) \subseteq \speD$.
%\end{observation}
%\begin{observation}
%If two-dimentional manifold  $M$ has a boundry, then $\sigma(M) \subseteq \speD$.
%\end{observation}
...
\section{Order type and topology of $\sigma$}
\begin{theorem}
