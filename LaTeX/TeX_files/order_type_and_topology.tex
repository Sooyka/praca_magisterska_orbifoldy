...
\section{Order type and topology of "order-$n$" accumulation points subsets of $\spe$}\label{spe_M} 
$\spe_n$ \\
...
\section{More about how this $\spe \simeq \omega^\omega$ lies in $\mathbb{R}$}
...
\subsection{$\speD$ and $\speS$}\label{D_and_S}
