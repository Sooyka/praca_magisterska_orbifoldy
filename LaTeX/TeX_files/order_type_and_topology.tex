...
as $\sbD$. 
So we have that $\sigma = \sbD \cup \sIS$. \\
% Let us denote the set of all possible \Eoc s of two-dimentional orbifolds as $\sigma$. \\
Let us also observe that the order type and topology of $\sIS$ and $\sbD$ are 
the same since 
...
$\sigma^I(M)$ - spectrum of all possible \Eoc\ of $M$ orbifolds with orbipoints only 
in the interior of $M$ \\
$\sigma^b(M)$ - spectrum of all possible \Eoc\ of $M$ orbifolds with orbipoints only 
on the boundry of $M$ (when $M$ has no boundry $\sigma^b(M) = \{\chi(M)\}$) \\
Examples that will be extensively use: \\
$\sIS$ - spectrum of all possible \Eoc\ of $S^2$ orbifolds \\
$\sbD$ - spectrum of all possible \Eoc\ of $D^2$ orbifolds with orbipoints only on the boundry 
(equal to $\sigma(D^2)$ - spectrum of all possible \Eoc\ of all $D^2$ orbifolds) \\

% We would like to make some more observations concerning subsets of $\sigma$. 
...
\begin{equation} 
\sigma(M) = \sigma^I(M) = \chi(M) - (\sIS - 2) 
\end{equation}
and
\begin{equation} 
\sigma(M) \subseteq \sIS 
\end{equation} 

If, in addition, $M \neq S^2$, then 
\begin{equation} 
\sigma(M) \subseteq \sbD. 
\end{equation}
...
\end{observation}
\begin{observation}
If two-dimentional manifold  $M$ has no boundry, then $\sigma(M) \subseteq \sIS$. 
If, in addition, $M \neq S^2$, then 
$\sigma(M) \subseteq \sbD$.
\end{observation}
\begin{observation}
If two-dimentional manifold  $M$ has a boundry, then $\sigma(M) \subseteq \sbD$.
\end{observation}
...
In this section we will justify, that the order type of the spectrum all possible 
Euler orbicharacteristics 
of two dimensional orbifolds $\sigma$ is $\omega^\omega$. 
We will also describe precisely where accumulation points of the spectrum lie and of which order 
(see below \ref{accumulation_points_definitions}) they are. \\
To do so, remembering that $\sigma = \sIS \cup \sbD$ and \ref{all_spectra_are_isomorphic} we 
will first study how $\sbD$ looks like.
...
\section{Determining the topology}
